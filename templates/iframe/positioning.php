<h3 class="intergeo_tlbr_ul_li_h3"><?php esc_html_e( 'Positioning & Zooming', 'intergeo' ) ?></h3>
<ul class="intergeo_tlbr_ul_li_ul">
	<li class="intergeo_tlbr_ul_li_ul_li">
		<p class="intergeo_tlbr_grp_dsc">
			<?php esc_html_e( 'If you want to set specific map position and certain level of zooming, just set it up on preview map and these settings will be remembered at published map.', 'intergeo' ) ?>
		</p>
	</li>
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Positioning', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<?php esc_html_e( 'The initial map type', 'intergeo' ) ?>
			...
			<div class="intergeo_tlbr_cntrl_item">
				...
				<label>
					...
					<?php esc_html_e( 'Draggable map', 'intergeo' ) ?>
				</label>
			</div>
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'If unchecked prevents the map from being dragged. Dragging is enabled by default.', 'intergeo' ) ?>
			</p>
		</div>
	</li>
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Zooming', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<?php esc_html_e( 'Zoom range values', 'intergeo' ) ?>
			</div>
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'The maximum (19) and minimum (0) zoom levels which could be displayed on the map.', 'intergeo' ) ?>
			</p>
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
					...
					<?php esc_html_e( 'Scrollwheel zooming', 'intergeo' ) ?>
				</label>
			</div>
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'Determines if scrollwheel zooming is enabled on the map.', 'intergeo' ) ?>
			</p>
		</div>
	</li>
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Preview settings', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
					<input type="checkbox" id="intergeo_map_lock_preview" value="1">
					<?php esc_html_e( 'Lock preview', 'intergeo' ) ?>
				</label>
			</div>
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( "Lock preview map to preserve changing of the viewport bounds and zoom level. Locking affects only on preview map and won't lock embedded map.", 'intergeo' ) ?>
			</p>
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
					<input type="checkbox" id="intergeo_show_map_center" value="1" <?php checked( $show_map_center ) ?>>
					<?php esc_html_e( 'Show map center', 'intergeo' ) ?>
				</label>
			</div>
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( "Show small red circle at the center of the map. It helps you to centralize the map bounds. Note that this option won't be displayed at frontend.", 'intergeo' ) ?>
			</p>
		</div>
	</li>
</ul>
