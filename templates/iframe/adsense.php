<h3 class="intergeo_tlbr_ul_li_h3"><?php esc_html_e( 'AdSense Integration', 'intergeo' ) ?></h3>
...
if ( ! intergeo_is_developer() ) {
	...
	if ( empty( $publisher_id ) ) :
		...
		printf( esc_html__( 'To make AdSense working on your maps, you have to setup your publisher ID. You can do it at the %1$ssettings page%2$s.', 'intergeo' ), '<a href="' . admin_url( 'options-media.php' ) . '" target="_blank">', '</a>' )
		?></p>
		</li><?php
	endif;
	?><li class="intergeo_tlbr_ul_li_ul_li">
			...
			<td class="intergeo_tlbr_cntrl_tbl_clmn">
				<select name="adsense_format" class="intergeo_tlbr_cntrl_slct">
					...
					<option value="SMALL_VERTICAL_LINK_UNIT" <?php selected( isset( $json['adsense']['format'] ) ? $json['adsense']['format'] == 'SMALL_VERTICAL_LINK_UNIT' : false ) ?>>
						<?php esc_html_e( 'Small Vertical Link Unit', 'intergeo' ) ?>
					</option>
					<option value="MEDIUM_VERTICAL_LINK_UNIT" <?php selected( isset( $json['adsense']['format'] ) ? $json['adsense']['format'] == 'MEDIUM_VERTICAL_LINK_UNIT' : false ) ?>>
						<?php esc_html_e( 'Medium Vertical Link Unit', 'intergeo' ) ?>
					</option>
					<option value="LARGE_VERTICAL_LINK_UNIT" <?php selected( isset( $json['adsense']['format'] ) ? $json['adsense']['format'] == 'LARGE_VERTICAL_LINK_UNIT' : false ) ?>>
						<?php esc_html_e( 'Large Vertical Link Unit', 'intergeo' ) ?>
					</option>
					<option value="X_LARGE_VERTICAL_LINK_UNIT" <?php selected( isset( $json['adsense']['format'] ) ? $json['adsense']['format'] == 'X_LARGE_VERTICAL_LINK_UNIT' : false ) ?>>
						<?php esc_html_e( 'Extra Large Vertical Link Unit', 'intergeo' ) ?>
					</option>
					<option value="SMALL_HORIZONTAL_LINK_UNIT" <?php selected( isset( $json['adsense']['format'] ) ? $json['adsense']['format'] == 'SMALL_HORIZONTAL_LINK_UNIT' : false ) ?>>
						<?php esc_html_e( 'Small Horizontal Link Unit', 'intergeo' ) ?>
					</option>
					<option value="LARGE_HORIZONTAL_LINK_UNIT" <?php selected( isset( $json['adsense']['format'] ) ? $json['adsense']['format'] == 'LARGE_HORIZONTAL_LINK_UNIT' : false ) ?>>
						<?php esc_html_e( 'Large Horizontal Link Unit', 'intergeo' ) ?>
					</option>
				</select>
			</td>
			<td class="intergeo_tlbr_cntrl_tbl_clmn">
	...
	<li class="intergeo_tlbr_ul_li_ul_li">
	<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Styles', 'intergeo' ) ?></span>
	<div class="intergeo_tlbr_cntrl_items">
	<div class="intergeo_tlbr_cntrl_item">
		<b><?php esc_html_e( 'Background color', 'intergeo' ) ?></b>
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<input class="color-picker-hex" type="text" name="adsense_backgroundColor" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'intergeo' ) ?>" value="<?php echo isset( $json['adsense']['backgroundColor'] ) ? esc_attr( $json['adsense']['backgroundColor'] ) : '#c4d4f3' ?>" data-default-color="#c4d4f3">
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<b><?php esc_html_e( 'Border color', 'intergeo' ) ?></b>
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<input class="color-picker-hex" type="text" name="adsense_borderColor" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'intergeo' ) ?>" value="<?php echo isset( $json['adsense']['borderColor'] ) ? esc_attr( $json['adsense']['borderColor'] ) : '#e5ecf9' ?>" data-default-color="#e5ecf9">
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<b><?php esc_html_e( 'Title color', 'intergeo' ) ?></b>
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<input class="color-picker-hex" type="text" name="adsense_titleColor" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'intergeo' ) ?>" value="<?php echo isset( $json['adsense']['titleColor'] ) ? esc_attr( $json['adsense']['titleColor'] ) : '#0000cc' ?>" data-default-color="#0000cc">
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<b><?php esc_html_e( 'Text color', 'intergeo' ) ?></b>
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<input class="color-picker-hex" type="text" name="adsense_textColor" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'intergeo' ) ?>" value="<?php echo isset( $json['adsense']['textColor'] ) ? esc_attr( $json['adsense']['textColor'] ) : '#000000' ?>" data-default-color="#000000">
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<b><?php esc_html_e( 'URL color', 'intergeo' ) ?></b>
	</div>
	<div class="intergeo_tlbr_cntrl_item">
		<input class="color-picker-hex" type="text" name="adsense_urlColor" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'intergeo' ) ?>" value="<?php echo isset( $json['adsense']['urlColor'] ) ? esc_attr( $json['adsense']['urlColor'] ) : '#009900' ?>" data-default-color="#009900">
	</div>
	</div>
	</li>
	<?php }?>
