<h3 class="intergeo_tlbr_ul_li_h3"><?php esc_html_e( 'Layers', 'intergeo' ) ?></h3>
<ul class="intergeo_tlbr_ul_li_ul">
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Traffic layer', 'intergeo' ) ?></span>
	...
	<li class="intergeo_tlbr_ul_li_ul_li">
		...
		<div class="intergeo_tlbr_cntrl_items">
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'Allows you to add bicycle information to your map. It renders a layer of bike paths, suggested bike routes and other overlays specific to bicycling usage on top of the given map. Additionally, the layer alters the style of the base map itself to emphasize streets supporting bicycle routes and de-emphasize streets inappropriate for bicycles.', 'intergeo' ) ?>
			</p>
		</div>
	</li>
<?php
