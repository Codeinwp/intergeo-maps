...
<h3 class="intergeo_tlbr_ul_li_h3"><?php esc_html_e( 'Controls', 'intergeo' ) ?></h3>
<ul class="intergeo_tlbr_ul_li_ul">
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Zoom control', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'The Zoom control displays a slider (for large maps) or small "+/-" buttons (for small maps) to control the zoom level of the map. This control appears by default in the top left corner of the map on non-touch devices or in the bottom left corner on touch devices.', 'intergeo' ) ?>
			</p>
				...
				<tr>
					<td class="intergeo_tlbr_cntrl_tbl_clmn">
						<select class="intergeo_tlbr_cntrl_slct" name="map_zoomControlOptions_position">
							<option value=""><?php esc_html_e( 'default position', 'intergeo' ) ?></option>
							<option value="TOP_LEFT" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'TOP_LEFT' : false ) ?>>
								<?php esc_html_e( 'Top Left', 'intergeo' ) ?>
							</option>
							<option value="TOP_CENTER" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'TOP_CENTER' : false ) ?>>
								<?php esc_html_e( 'Top Center', 'intergeo' ) ?>
							</option>
							<option value="TOP_RIGHT" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'TOP_RIGHT' : false ) ?>>
								<?php esc_html_e( 'Top Right', 'intergeo' ) ?>
							</option>
							<option value="RIGHT_TOP" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'RIGHT_TOP' : false ) ?>>
								<?php esc_html_e( 'Right Top', 'intergeo' ) ?>
							</option>
							<option value="RIGHT_CENTER" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'RIGHT_CENTER' : false ) ?>>
								<?php esc_html_e( 'Right Center', 'intergeo' ) ?>
							</option>
							<option value="RIGHT_BOTTOM" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'RIGHT_BOTTOM' : false ) ?>>
								<?php esc_html_e( 'Right Bottom', 'intergeo' ) ?>
							</option>
							<option value="BOTTOM_RIGHT" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'BOTTOM_RIGHT' : false ) ?>>
								<?php esc_html_e( 'Bottom Right', 'intergeo' ) ?>
							</option>
							<option value="BOTTOM_CENTER" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'BOTTOM_CENTER' : false ) ?>>
								<?php esc_html_e( 'Bottom Center', 'intergeo' ) ?>
							</option>
							<option value="BOTTOM_LEFT" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'BOTTOM_LEFT' : false ) ?>>
								<?php esc_html_e( 'Bottom Left', 'intergeo' ) ?>
							</option>
							<option value="LEFT_BOTTOM" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'LEFT_BOTTOM' : false ) ?>>
								<?php esc_html_e( 'Left Bottom', 'intergeo' ) ?>
							</option>
							<option value="LEFT_CENTER" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'LEFT_CENTER' : false ) ?>>
								<?php esc_html_e( 'Left Center', 'intergeo' ) ?>
							</option>
							<option value="LEFT_TOP" <?php selected( isset( $json['map']['zoomControlOptions']['position'] ) ? $json['map']['zoomControlOptions']['position'] == 'LEFT_TOP' : false ) ?>>
								<?php esc_html_e( 'Left Top', 'intergeo' ) ?>
							</option>
						</select>
					</td>
					<td class="intergeo_tlbr_cntrl_tbl_clmn">
	...
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Pan control', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'The Pan control displays buttons for panning the map. This control appears by default in the top left corner of the map on non-touch devices. The Pan control also allows you to rotate 45° imagery, if available.', 'intergeo' ) ?>
			</p>
			<table class="intergeo_tlbr_cntrl_tbl" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="intergeo_tlbr_cntrl_tbl_clmn">
	...
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Scale control', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'The Scale control displays a map scale element. This control is not enabled by default.', 'intergeo' ) ?>
			</p>
			<table class="intergeo_tlbr_cntrl_tbl" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="intergeo_tlbr_cntrl_tbl_clmn">
	...
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'MapType control', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'The MapType control lets the user toggle between map types (such as roadmap and satellite). This control appears by default in the top right corner of the map.', 'intergeo' ) ?>
			</p>
			<table class="intergeo_tlbr_cntrl_tbl" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="intergeo_tlbr_cntrl_tbl_clmn">
					...
					<td class="intergeo_tlbr_cntrl_tbl_clmn">
						<select class="intergeo_tlbr_cntrl_slct" name="map_mapTypeControlOptions_style">
							...
							<option value="DROPDOWN_MENU" <?php selected( isset( $json['map']['mapTypeControlOptions']['style'] ) ? $json['map']['mapTypeControlOptions']['style'] == 'DROPDOWN_MENU' : false ) ?>>
								<?php esc_html_e( 'dropdown menu', 'intergeo' ) ?>
							</option>
							<option value="HORIZONTAL_BAR" <?php selected( isset( $json['map']['mapTypeControlOptions']['style'] ) ? $json['map']['mapTypeControlOptions']['style'] == 'HORIZONTAL_BAR' : false ) ?>>
								<?php esc_html_e( 'horizontal bar', 'intergeo' ) ?>
							</option>
						</select>
					</td>
				</tr>
			...
			<div class="intergeo_tlbr_cntrl_item">
				<b><?php esc_html_e( 'Map types:', 'intergeo' ) ?></b>
			</div>
			<div class="intergeo_tlbr_cntrl_item">
				<label title="<?php esc_attr_e( 'This map type displays a normal street map.', 'intergeo' ) ?>">
					...
					<?php esc_html_e( 'Road map', 'intergeo' ) ?>
				</label>
			</div>
			<div class="intergeo_tlbr_cntrl_item">
				<label title="<?php esc_attr_e( 'This map type displays maps with physical features such as terrain and vegetation.', 'intergeo' ) ?>">
					...
					<?php esc_html_e( 'Terrain', 'intergeo' ) ?>
				</label>
			</div>
			<div class="intergeo_tlbr_cntrl_item">
				<label title="<?php esc_attr_e( 'This map type displays satellite images.', 'intergeo' ) ?>">
					...
					<?php esc_html_e( 'Satellite', 'intergeo' ) ?>
				</label>
			</div>
			<div class="intergeo_tlbr_cntrl_item">
				<label title="<?php esc_attr_e( 'This map type displays a transparent layer of major streets on satellite images.', 'intergeo' ) ?>">
					...
					<?php esc_html_e( 'Hybrid', 'intergeo' ) ?>
				</label>
			</div>
		</div>
	</li>
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Street View control', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'The Street View control contains a Pegman icon which can be dragged onto the map to enable Street View. This control appears by default in the top left corner of the map.', 'intergeo' ) ?>
			</p>
			<table class="intergeo_tlbr_cntrl_tbl" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="intergeo_tlbr_cntrl_tbl_clmn">
	...
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Rotate control', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'The Rotate control contains a small circular icon which allows you to rotate maps containing oblique imagery. This control appears by default in the top left corner of the map.', 'intergeo' ) ?>
			</p>
			<table class="intergeo_tlbr_cntrl_tbl" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="intergeo_tlbr_cntrl_tbl_clmn">
	...
	<li class="intergeo_tlbr_ul_li_ul_li">
		<span class="intergeo_tlbr_cntrl_ttl"><?php esc_html_e( 'Overview Map control', 'intergeo' ) ?></span>
		<div class="intergeo_tlbr_cntrl_items">
			<div class="intergeo_tlbr_cntrl_item">
				<a class="intergeo_tlbr_cntrl_more_info" href="javascript:;">[?]</a>
				<label>
			...
			<p class="intergeo_tlbr_cntrl_dsc">
				<?php esc_html_e( 'The Overview Map control displays a thumbnail overview map reflecting the current map viewport within a wider area. This control appears by default in the bottom right corner of the map, and is by default shown in its collapsed state.', 'intergeo' ) ?>
			</p>
			<div class="intergeo_tlbr_cntrl_item">
				<label>
					...
					<?php esc_html_e( 'Opened', 'intergeo' ) ?>
				</label>
			</div>
		</div>
	</li>
