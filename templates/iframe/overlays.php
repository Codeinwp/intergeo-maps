		...
		<table class="intergeo_tlbr_cntrl_tbl intergeo_tlbr_marker_add" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="intergeo_tlbr_marker_title_td_add">
					...
					<a  target="_blank" href="<?php echo INTERGEO_PRO_URL; ?>" style='display:none' class="intergeo-pro-btn button"><?php _e( 'Buy PRO version to add more markers', 'intergeo' ) ?></a>
					<?php } else { ?>

							<a  target="_blank" href="<?php echo INTERGEO_PRO_URL; ?>" class="intergeo-pro-btn button"><?php _e( 'Buy PRO version to add more markers', 'intergeo' ) ?></a>
					<?php } ?>
				</td>
			</tr>
		</table>
