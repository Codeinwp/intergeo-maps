<li class="intergeo_tlbr_ul_li_ul_li">
    <p class="intergeo_tlbr_grp_dsc">
        <?php esc_html_e( 'To import data, please import a CSV file. Here is a sample', 'intergeo' ) ?>
		: <a href="<?php echo INTERGEO_ABSURL . 'samples/default.csv' ?>" target="_blank"><?php esc_html_e( 'Click here', 'intergeo' ); ?></a>
	</p>
</li>
	...
	<div class="intergeo_tlbr_cntrl_items" style="display:block">
		<div class="form-inline">
			<div class="button button-primary file-wrapper computer-btn">
				...
				<?php esc_attr_e( 'From Computer', 'intergeo' ) ?>
			</div>
		</div>
	</div>
</li>
...
<li class="intergeo_tlbr_ul_li_ul_li">
	<p class="intergeo_tlbr_grp_dsc">
		<?php esc_html_e( 'To export data, click on the button below', 'intergeo' ) ?>
	</p>
</li>
	...
	<div class="intergeo_tlbr_cntrl_items" style="display:block">
		<div class="form-inline">
			<div class="button button-primary file-wrapper computer-btn" id="intergeo_export_csv">
				...
				<?php esc_attr_e( 'Export markers as CSV', 'intergeo' ) ?>
			</div>
		</div>
	</div>
</li>
