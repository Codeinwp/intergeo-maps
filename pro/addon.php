...
if (!class_exists( 'IntergeoMaps_Adv' )) {
    ...
    class IntergeoMaps_Adv{
        ...
        function i18n(){
            $pluginDirName  = INTERGEO_DIRNAME;
        ...
        public static function writeDebug($msg){
            if(INTERGEO_DEBUG) file_put_contents(INTERGEO_DIR . "tmp/log.log", date("F j, Y H:i:s") . " - " . $msg."\n", FILE_APPEND);
        }
        ...
        public function addValidations(&$validationArray, &$defaults){
            ...
            $validationArray['custom_latne'] = array( 'filter' => FILTER_VALIDATE_FLOAT, 'flags' => FILTER_REQUIRE_SCALAR, 'options' => array( 'min_range' => -90, 'max_range' => 90, 'default' => 48.1366069 ) );
            $validationArray['custom_lonne'] = array( 'filter' => FILTER_VALIDATE_FLOAT, 'flags' => FILTER_REQUIRE_SCALAR, 'options' => array( 'min_range' => -180, 'max_range' => 180, 'default' => 11.577085099999977 ) );
            $validationArray['custom_latsw'] = array( 'filter' => FILTER_VALIDATE_FLOAT, 'flags' => FILTER_REQUIRE_SCALAR, 'options' => array( 'min_range' => -90, 'max_range' => 90, 'default' => 48.1366069 ) );
            $validationArray['custom_lonsw'] = array( 'filter' => FILTER_VALIDATE_FLOAT, 'flags' => FILTER_REQUIRE_SCALAR, 'options' => array( 'min_range' => -180, 'max_range' => 180, 'default' => 11.577085099999977 ) );
        ...
        public function enqueueScriptsAndStyles($deps, $data=null){
            ...
            wp_localize_script( 'intergeo-maps-pro', 'igmp', array(
                ...
                "messages"  => array(
                    "save_map"  => __("Please save the map before clicking on the export button", INTERGEO_PLUGIN_NAME),
                )
            ) );
        }
