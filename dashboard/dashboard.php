...
if ( ! class_exists( 'THEMEISLE_DASHBOARD' ) ) {
	...
	final class THEMEISLE_DASHBOARD {
		...
		public function setup_vars(){
			...
			$this->feeds = apply_filters('themeisle_sdk_dashboard_widget_feeds',array('https://themeisle.com/blog/feed','https://codeinwp.com/blog/feed'));
			...
			<style type="text/css">
				...
				<ul>
					...
					foreach($this->items as $item){
						?>
						 <li class="ti-dw-feed-item"><span class="ti-dw-date-container"><span class="ti-dw-day-container"><?php echo date('d',$item['date']); ?></span> <span class="ti-dw-month-container"><?php echo substr(date('M',$item['date']),0,3); ?></span></span><a href="<?php echo add_query_arg(
						 	        array(
						 	        	'utm_campaign'=>'feed',
